...
CONTENT;
    ...
    #[Test]
    public function createsAGitattributesFileWithNegatedExportIgnoreDirectivesAndTwoKeptArtefacts(): void
    {
        $artifactFilenames = ['LICENSE.md', 'README.md', '.gitignore', 'composer.json'];
...
CONTENT;
    ...
    #[Test]
    public function createsAGitattributesFileWithNegatedExportIgnoreDirectivesAndAutoDetectedMitLicense(): void
    {
        $artifactFilenames = ['LICENSE.md', 'README.md', '.gitignore', 'composer.json'];
        ...
        \file_put_contents($this->temporaryDirectory . DIRECTORY_SEPARATOR . 'LICENSE.md', 'The MIT License (MIT)');
...
CONTENT;
        ...
        $this->assertStringContainsStringIgnoringLineEndings(
            $expectedGitattributesContent,
            \file_get_contents($gitattributesPath)
        );
    }
