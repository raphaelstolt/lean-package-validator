...
### Fixed
- Moved skills directory for [Boost](https://laravel.com/docs/12.x/boost) inclusion.
...
### Fixed
- The complete directory path is used in user output. Closes [#59](https://github.com/raphaelstolt/lean-package-validator/issues/59).
...
[Unreleased]: https://github.com/raphaelstolt/lean-package-validator/compare/v5.8.0...HEAD
